...
import { LogOut, MessageCircle, Package, Calculator, ChevronDown, FolderOpen, User, Eye, ScanSearch, Bot, PanelRightClose, PanelRightOpen } from 'lucide-react';
...
const adminItems = [
  ...
  { path: '/precise-ai', label: 'PreciseAI', icon: Bot },
