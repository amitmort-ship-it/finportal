        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border">
              {STAGES.map(stage => (
                <th key={stage} className="px-4 py-2.5 text-center font-medium text-muted-foreground whitespace-nowrap text-xs border-l last:border-l-0 border-border">
          ...
          <tbody>
            <tr>
              {STAGES.map(stage => (
                <td key={stage} className="px-4 py-3 align-top text-center border-l border-t border-border last:border-l-0">
