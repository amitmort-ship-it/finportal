...
const THRESHOLD = 0.5; // פער מינימלי לסימון
  ...
  return (
    <div className="bg-amber-50 border border-amber-200 rounded-xl p-5 mb-6" dir="rtl">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="font-bold text-amber-800">לקוחות בסטטוס מחזור פוטנציאלי ({candidates.length})</h3>
      </div>
      <div className="space-y-2">
        {candidates.map(c => (
          <div key={c.id} className="bg-white rounded-lg border border-amber-200 px-4 py-3 flex items-center justify-between gap-4">
            <div>
